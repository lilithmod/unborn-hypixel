...
import { processMegaKits, processRankedKits, processSoloKits } from './processSkywarsKits.js'
...
export function processSkywars(json: RawSkywars, processKits: boolean = false): Skywars {
    const cages = []
    const kits = []
    const favoriteMaps = []
    const deathCries = []
    ...
    return {
        ...
        gamemodes: {
            ...
            mega: {
                ...
                kits: processKits ? processMegaKits(json) : undefined,
                kitLevels: {
